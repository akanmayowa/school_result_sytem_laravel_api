...
class ScoreMarkerTwo extends Model
{
    use HasFactory;
    ...
    public function candidateIndexForScoreMarkerTwo(): \Illuminate\Database\Eloquent\Relations\BelongsTo
    {
        return $this->belongsTo(CandidateIndexing::class, 'candidate_index', 'candidate_index');
    }


    public function CourseModuleForScoreMarkerTwo(): \Illuminate\Database\Eloquent\Relations\BelongsTo
    {
